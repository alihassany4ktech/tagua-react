                                          ...
                                          <div className="col-auto">
                                                <div className="page-utilities">
                                                      <div className="row g-2 justify-content-start justify-content-md-end align-items-center">
                                                            ...
                                                            <div className="col-auto">
                                                                  <NavLink exact={true} to={`/${url}/create-blog`} type="submit" className="btn  app-btn-secondary "> <i className="fa fa-plus"></i> Create Blog</NavLink>
                                                            </div>
                                                      </div>
                                                </div>
                                          </div>
                                                                                    ...
                                                                                    <td className="cell">
                                                                                          <div class="dropdown">
                                                                                                ...
                                                                                                <ul class="dropdown-menu">
                                                                                                      ...
                                                                                                      <li><NavLink exact to={`${match.url}`} class="dropdown-item"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
