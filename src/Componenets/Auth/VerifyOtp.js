                  ...
                  <div className="row g-0 app-auth-wrapper">
                        <div className="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5 mt-5">
                              <div className="d-flex flex-column align-content-end">
                                    <div className="app-auth-body mx-auto">
                                          ...
                                          <h2 className="auth-heading text-center mb-4">Verify OTP</h2>
                                          <p className="text-center mb-5">Enter <strong>OTP</strong> that sent to yor email.</p>
                                          <div className="auth-form-container text-start">
                                                <form className="auth-form login-form" onSubmit={onSubmit}>
                                                      <div className="email mb-3">

                                                            <input id="signin-email" name="email" value={data.email} type="email" className="form-control signin-email" placeholder="Enter OTP" onChange={inputEvent} />
                                                            <span className="text-danger" style={{ fontSize: "12px" }}>{message.email}</span>
                                                      </div>
                                                      <div className="text-center mt-3">
                                                            <button type="submit" className="btn app-btn-primary w-100 theme-btn mx-auto">Verify</button>
                                                      </div>
                                                </form>
                        ...
                        <div className="col-12 col-md-5 col-lg-6 h-100 auth-background-col">
                              ...
                              <div className="auth-background-mask">
                                    <img src="https://picsum.photos/id/5/760/747" alt="" />
                              </div>
                        </div>
